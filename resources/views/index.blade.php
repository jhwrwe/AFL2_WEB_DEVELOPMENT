...
<body>
    <div class ="bg-black">
      <div class="d-flex flex-column align-items-center justify-content-center vh-100 position-relative m-0 p-0 bg-light">
        ...
        <img class="position-absolute w-100 h-100 rounded" style="object-fit: cover; z-index: 1; opacity: 0.5;" src="https://source.unsplash.com/random/160x160?car" alt="Image">
