    ...
    <a href ="/Teachers_info/{{$user['id']}}">
        <div class="lg:flex items-center justify-center w-full">
            <div tabindex="0" aria-label="card" class="focus:outline-none lg:w-4/12 lg:mr-7 lg:mb-0 mb-7 bg-white p-6 shadow rounded">
                <div class="flex items-center border-b border-gray-200 pb-6">
                    ...
                    <div class="flex items-start justify-between w-full">
                        <div class="pl-3 w-full">
                            <p tabindex="0" class="focus:outline-none text-xl font-medium leading-5 text-gray-800">{{ $user->name }}</p>
                            <p tabindex="0" class="focus:outline-none text-sm leading-normal pt-2 text-gray-500">{{ $user->about }}</p>
                        </div>
                ...
                <div class="px-2">
                    <p tabindex="0" class="focus:outline-none text-sm leading-5 py-4 text-gray-600">{{ $user['phone'] }}</p>
                    <p tabindex="0" class="focus:outline-none text-sm leading-5 py-4 text-gray-600">{{ $user->email }}</p>
                </div>
            </div>
        </div>
    </a>
